...
export const Finalresume = () => {
    ...
    today = mm + '-' + dd + '-' + yyyy;
    return <div><div>
        <div className='btncontainer'><button style={{ marginTop: "2%", backgroundColor: "lightblue", border: "none", color: "white", padding: "4px 4px", cursor: "pointer", fontSize: "15px", marginLeft: "90%" }} onClick={() => {
            if (pdfExportComponent.current) {
                pdfExportComponent.current.save();
                localStorage.clear();
            }
        }}><i class="fa fa-download"></i> Download</button></div>
        <PDFExport paperSize="A4" margin="1cm" ref={pdfExportComponent}>
            <div className='maincontainer' style={{ width: "100%", marginLeft: "0", marginTop: "-3%" }}>
                <div className='output'>
                    <div className='container' style={{ marginLeft: "0%", marginTop: "0%" }}>
                        <h1 style={{ fontSize: "15px", fontWeight: "bold" }}>{localStorage.getItem('firstname') + '\n' + localStorage.getItem('lastname')}</h1>
                        <h1 style={{ fontSize: "12px", fontWeight: "bold" }}>{localStorage.getItem('collegequalification') + '\n' + localStorage.getItem('collegedescription')}</h1>
                        <div className='container'><p style={{ fontSize: "11px", width: "25%" }}>{localStorage.getItem('address')}
                        </p></div>
                        <div style={{ marginTop: "-1.5%" }}><p style={{ fontSize: "12px", display: "inline-block", }}><b>Contact: </b></p><p style={{ display: "inline-block", fontSize: "11px" }}>{'\n' + localStorage.getItem('phonenumber')}</p></div>
                        <div style={{ marginTop: "-2.2%" }}><p style={{ fontSize: "12px", display: "inline-block" }}><b>Email: </b></p><p style={{ display: "inline-block", fontSize: "11px" }}>{'\n' + localStorage.getItem('email')}</p></div>
                        <div style={{ marginTop: "-1.6%", fontSize: "11px" }}>  <p style={linkedin ? { display: "none" } : {}}><b>Linked in:</b>{'\n' + localStorage.getItem('linkedin')}</p></div>
                        <div style={{ marginTop: "-1.6%", fontSize: "11px" }}>  <p style={github ? { display: "none" } : {}}><b>Github:</b>{'\n' + localStorage.getItem('github')}</p></div>
                        <div style={{ marginTop: "-1.6%", fontSize: "11px" }}>  <p style={facebook ? { display: "none" } : {}}><b>Facebook:</b>{'\n' + localStorage.getItem('facebook')}</p></div>
                        <div style={{ marginTop: "-1.6%", fontSize: "11px" }}>  <p style={twitter ? { display: "none" } : {}}><b>Twitter:</b>{'\n' + localStorage.getItem('twitter')}</p></div>
                        <div style={{ marginTop: "-1.6%", fontSize: "11px" }}>  <p style={instagram ? { display: "none" } : {}}><b>Instagram:</b>{'\n' + localStorage.getItem('instagram')}</p></div>
                        <br />
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>CAREER OBJECTIVE:</h1>
                        ...
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>BASIC ACADAMIC CREDENTIALS:</h1>
                        <br />
                        <br />
                        ...
                        <br />
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>PROJECTS DONE:</h1>
                        <br />
                        <div className='container' style={{ marginLeft: "2%", fontSize: "11px" }}>
                            <p><b>Title:</b>{'\n' + localStorage.getItem('project1title')}</p>
                            <p><b>Link:</b>{'\n' + localStorage.getItem('project1link')}</p>
                            <p><b>Description:</b>{'\n' + localStorage.getItem('project1description')}</p>
                        </div>
                        <div className='container' style={{ marginLeft: "2%", fontSize: "11px" }}>
                            <p style={project2title ? { display: "none" } : {}}><b>Title:</b>{'\n' + localStorage.getItem('project2title')}</p>
                            <p style={project2link ? { display: "none" } : {}}><b>Link:</b>{'\n' + localStorage.getItem('project2link')}</p>
                            <p style={project2description ? { display: "none" } : {}}><b>Description:</b>{'\n' + localStorage.getItem('project2description')}</p>
                        </div>
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>{localStorage.getItem('skill1') ? "TECHNICAL SKILLS:" : ""}</h1>
                        <br />
                        <div className='container' style={{ marginLeft: "2%", fontSize: "11px" }}>
                        ...
                        <br />
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>AREA OF INTREST:</h1>
                        <br />
                        <div className='container' style={{ marginLeft: "2%", fontSize: "11px" }}>
                        ...
                        <br />
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>WORKSHOP ATTENDED:</h1>
                        <br />
                        <div className='container' style={{ width: "100%", marginLeft: "0%", fontSize: "11px" }}><li>{localStorage.getItem('workshop1')}</li></div>
                        ...
                        <br />
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>PERSONAL SKILLS:</h1>
                        <br />
                        ...
                        <br />
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>PERSONAL DETAILS:</h1>
                        <br />
                        <div className='container' style={{ marginLeft: "0%", fontSize: "11px" }}>
                            ...
                            <p><b>Language Proficiency :</b>{'\n' + localStorage.getItem('languageproficiency')}</p></div>
                        <br />
                        <h1 style={{ fontSize: "12px", fontWeight: "bold", display: "inline-block" }}>DECLARATION:</h1>
                        <p style={{ fontSize: "11px" }}>I hereby declare that the above given information is true to the best of my knowledge.</p>
                        <br />
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <p style={{ display: "inline-block", fontSize: "11px" }}><b>Place:</b>{localStorage.getItem('place')}</p>
                            <p style={{ marginLeft: "0%", display: "inline-block", fontSize: "11px" }}><b>({localStorage.getItem('firstname') + '\n' + localStorage.getItem('lastname')})</b></p>
                        </div>
                        <p style={{ fontSize: "11px" }}><b>Date:</b> {today}</p>
                    </div>
