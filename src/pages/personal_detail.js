...
export const Personaldetails = () => {
    ...
    const nextStep = (e) => {
        e.preventDefault();
        if (fathername === null || dateofbirth === "" || gender === null ||
            maritalstatus === "" || nationality === "" || languageproficiency === "" || place === null) {
        ...
        <div className='output'>
            ...
            <div id="skillset">
                <form id='presonal-form'>
                    ...
                    <div className="row">
                        <div className="col">
                            <input type="date" className="form-control" placeholder="Date Of Birth *" value={dateofbirth} onChange={(e) => { setdateofbirth(e.target.value); localStorage.setItem('dateofbirth', e.target.value) }} />
                        </div>
